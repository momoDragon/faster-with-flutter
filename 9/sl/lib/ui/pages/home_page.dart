...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _setInitialPreferences() async {
    UserPreferenceModel userPreferenceModel =
        await GetIt.I<IUserPreferencesRepository>().getUserPreference();
    _showMusic.value = userPreferenceModel.showMusic;
    _showVideo.value = userPreferenceModel.showVideo;
    _showImage.value = userPreferenceModel.showImage;
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          TextButton(
              onPressed: () async {
                await GetIt.I<IUserPreferencesRepository>().saveUserPreference(
                    UserPreferenceModel(
